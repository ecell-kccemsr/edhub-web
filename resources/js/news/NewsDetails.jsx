...
//                 axios
//                     .get(`/api/news/sub_categories?category_id=${id}`)
//                     .then(res => {
//                         setsubcategory(res.data.data);
//                     });

//                 axios.get(`/api/news?subcategory_id=${sub_id}`).then(res => {
//                     setNewsAtGlance(res.data.data);
//                 });
//                 axios.get("/api/news/trending").then(res => {
...
//                         {
//                             title: `${newsslug}`,
//                             link: `/news/${categoryslug}/${subcategoryslug}/${newsslug}`,
//                             active: true
//                         }
//                     ]}
//                 />
