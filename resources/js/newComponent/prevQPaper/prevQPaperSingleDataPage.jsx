    ...
    return (
        <>
            <Helmet>
                <meta
                    name="keywords"
                    content="edhub, question-paper, india, trending, exams, detail"
                />
                <meta
                    name="description"
                    content="Question paper detail page where single question paper is added"
                />
            ...
            <div className="prev-qpaper-singledata-section">
                ...
                {/* Courses */}
                {course && (
                    <PopularChoice data={course} title="Latest Courses" />
                )}
            </div>
        </>
    );
