...
const SingleNewsPage = props => {
    ...
    const [modalTweet, setModalTweet] = useState(null);
    ...
    return (
        <>
            <Helmet>
                <meta
                    name="keywords"
                    content="edhub, news, india, trending, detail"
                />
                <meta
                    name="description"
                    content="Detail of blogs in this page"
                />
                                                ...
                                                <div className="container comment-section-news">
                                                    ...
                                                    {showComments && (
                                                        <>
                                                            ...
                                                            {commentPage?.current_page <
                                                                commentPage?.last_page && (
                                                                <button
                                                                    onClick={() =>
                                                                        getComment(
                                                                            news_slug,
